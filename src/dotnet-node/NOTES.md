# .NET + Node.js (Trusted) Template

This template provides a hardened .NET and Node.js development environment built on a trusted UBI9 base image.

## Included Tools

- **.NET SDK** for C# and F# development
- **Node.js**, **npm**, and **pnpm** for JavaScript/TypeScript development
